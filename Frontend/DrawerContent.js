...
const DrawerList = [
  { icon: 'login', label: 'Login/Signup', navigateTo: 'login' },
  { icon: 'home', label: 'Home', navigateTo: 'Home' },
  { icon: 'document', label: 'Add Notes', navigateTo: 'AddNewNote' },
  { icon: 'upload', label: 'Upload Notes', navigateTo: 'UploadNotes' },
];
